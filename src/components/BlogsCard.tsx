...
const BlogCard: FC<IBlogCardListpProps> = ({ blogData,deleteCB}) => {
    ...
    async function deleteBlog() {
        ...
        try {
            ...
            const axiosErr = handleAxiosError(error)
            if (isApiError(axiosErr)) {
                axiosErr.error
            }
        }
    }
    ...
    return (
        ...
        <div className="card card-compact bg-base-100 shadow-xl">
            ...
            {!isHome &&
                <>
                    <button onClick={(e) => onAction(e, Action.DELETE)} className="delete absolute top-2 right-4 ml-2 opacity-15 hover:opacity-100 transition-opacity ease-in-out">
                    ...
                    <button onClick={(e) => onAction(e, Action.Edit)} className="edit absolute top-0.5 right-10 opacity-15 hover:opacity-100 transition-opacity ease-in-out ">
